...
module ActiveMerchant
  module Shipping
    module TestFixtures
      ...
      @@line_items1 = [
        PackageItem.new("IPod Nano - 8gb - green", 200, 199.00, 2, {:sku => "IPOD2008GREEN", :hs_code => "1234.12.12.12", country_of_origin: 'US'}),
        PackageItem.new("IPod Nano - 8gb - black", 200, 199.00, 1, {:sku => "IPOD2008GREEN", :hs_code => "1234.12.12.12", country_of_origin: 'CN'})
      ]
